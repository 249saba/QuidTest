      ...
      <CustomCard styleClass="p-4">
        <div className="flex  justify-between  gap-2">
          <div className="text-left ">
            {/* <p className="text-gray-900 flex gap-1">
              <span>Dashboard</span>/<span>Settings</span>/<span>About Us</span>
            </p> */}
        ...
        <div className="flex flex-col text-black-900 justify-between pt-2">
          ...
          >
            ...
            <div className="flex gap-3 flex-col items-start text-left pt-3 text-gray-400 font-poppins pb-10">
              <p>
              ...
              <p>
                ...
                and contact details when you register an account or engage with
                our services. This information is used to provide a personalized
                and seamless experience, improve our services, and communicate
                important updates.We may also collect non-personal information,
                such as device information and website usage data, to analyze
                trends, enhance functionality, and optimize user experience.
                This data is collected through cookies and similar technologies.
              </p>
              <p>
                FrankZone may update this Privacy Policy periodically, and any
                changes will be communicated to you through the platform or via
                email. By continuing to use our services after such updates, you
                indicate your acceptance of the revised Privacy Policy.
              </p>
              <p>
                {" "}
                Please take the time to review this Privacy Policy thoroughly.
                Your continued use of FrankZone signifies your understanding and
              ...
              <p>Thank you for choosing FrankZone.</p>
            </div>
            {/* <div className="flex gap-4 sm:ml-auto pt-20 ">
              <CustomButton
                // handleButtonClick={() => {
