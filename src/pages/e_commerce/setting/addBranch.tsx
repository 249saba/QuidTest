...
import TestImg from "@assets/icons/Mask Group 359.png";
...
const FormSchema = Yup.object().shape({
  ...
  cover_url: Yup.mixed().required("Cover image is required"),
});

const AddBranch = ({ handleNew, label }: any) => {
        ...
        {({
          ...
          return (
            <Form>
              ...
              <CustomCard styleClass="p-4">
                <div className="flex  justify-between  gap-2">
                  <div className="text-left ">
                    ...
                    <span>Shop Management</span>/<span>Branches</span>
                  </p> */}
                    <Breadcrumbs
                    ...
                    >
                      ...
                      {/* <Link to="/settings/shopList" className="text-gray">
                      <p>{"Shop Management"}</p>
                    </Link> */}
                      <p
                        onClick={() => {
                    ...
                    <h6 className="font-normal">Add New Branch</h6>
                  </div>
              ...
              <CustomCard styleClass="p-4 mt-2">
                <div>
                    ...
                    <div className="space-y-10">
                      <div className=" bg-[#dcdde2a5]  rounded-[10px]  w-full h-52">
                        <ImagePicker
                          ...
                          onChange={(files) => {
                            ...
                            return uploadImage("cover_url", files);
                          }}
                          touched={true}
                        >
                          <div className="flex h-40  items-center gap-4 w-full px-5 justify-center ">
                            {" "}
                            <img
                              src={
                            ...
                            <CustomButton
                              ...
                              type={"button"}
                              styleClass="btn-black !rounded-lg  "
                            />
                            <ErrorMessage
                              name={`cover_url`}
                              component={"span"}
                        ...
                        <div className="absolute left-[50%]  top-[15%] ">
                          <ImagePicker
                            ...
                            onChange={(files) => {
                              ...
                              return uploadImage("image_url", files);
                            }}
                            touched={true}
                          >
                            <img
                            ...
                            />
                            <div className="w-8 h-8 rounded-full bg-white absolute right-[-40px]  bottom-0 z-50 p-2">
                              {" "}
                              <PencilIcon
                                className={
                      ...
                      <div className="space-y-3 ">
                        ...
                        <div className="text-left flex-col gap-3">
                          <label className="text-sm text-black-900 text-left">
