...
var $r = class {
  constructor({ apiKey: e4, authReferrerPolicy: t2, channel: n2, client: o2, id: r2 = "__googleMapsScriptId", language: i2, libraries: a2 = [], mapIds: c2, nonce: s2, region: u2, retries: l2 = 3, url: d2 = "https://maps.googleapis.com/maps/api/js", version: p2 }) {
    if (this.CALLBACK = "__googleMapsCallback", this.callbacks = [], this.done = false, this.loading = false, this.errors = [], this.apiKey = e4, this.authReferrerPolicy = t2, this.channel = n2, this.client = o2, this.id = r2 || "__googleMapsScriptId", this.language = i2, this.libraries = a2, this.mapIds = c2, this.nonce = s2, this.region = u2, this.retries = l2, this.url = d2, this.version = p2, $r.instance) {
      if (!Qr(this.options, $r.instance.options))
        throw new Error(`Loader must not be called again with different options. ${JSON.stringify(this.options)} !== ${JSON.stringify($r.instance.options)}`);
      return $r.instance;
    }
    $r.instance = this;
  }
